...
import { LayoutDashboard, Settings, Building2, Banknote, BarChart3, Sparkles, PackageSearch, ShieldCheck, CreditCard } from "lucide-react";
...
export function AdminLayout({ children }: AdminLayoutProps) {
  ...
  return (
    <BaseDashboardLayout navItems={adminNavItems} userRole="admin">
      {children}
    </BaseDashboardLayout>
  );
}
