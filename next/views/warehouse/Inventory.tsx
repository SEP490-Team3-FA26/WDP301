                      ...
                      {item.stock <= item.minStock && (
                        <button
                          onClick={() => {
                            ...
                            if (typeof window !== "undefined") { sessionStorage.setItem("purchase_order_prefill", JSON.stringify({ prefillPrItems: [{ medicineId: item.id, quantity: Math.max(20, (item.minStock || 50) * 2 - item.stock) }] })); } router.push(importPath);
                          }}
              ...
              <button
                onClick={() => {
                  ...
                  if (typeof window !== "undefined") {
                    sessionStorage.setItem("purchase_order_prefill", JSON.stringify({
