...
export function Login() {
  ...
  useEffect(() => {
    ...
    if (token) {
      login(token, "user"); // Mặc định role user từ google login
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Lưu JWT Token và Role vào Context & LocalStorage
  ...
  return (
    <>
           ...
           <div className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-11 pr-4 py-3 bg-white border border-slate-200 rounded-xl text-sm text-slate-800 font-semibold shadow-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500" 
                  required
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center mb-1">
                ...
                <Link href="/auth/forgot-password" className="text-sm font-semibold text-[#0057cd] hover:underline">
                  Quên mật khẩu?
                </Link>
              </div>
              <div className="relative">
      ...
      <div className="mt-8 text-center text-sm font-medium border-t border-slate-200/60 pt-6">
        ...
        <Link href="/auth/register" className="font-bold text-[#0057cd] hover:text-[#00419e] transition-colors hover:underline">
          Đăng ký ngay
        </Link>
      </div>
    </>
